...
const Steps = ({ currentStep }) => {
    const steps = [
        {title : "Select Subscription", value : 1},
        {title: "Setup your Restaurant", value: 2},
        {title: "Setup your Menu", value: 3},
        {title: "Generate QR", value: 4},
    ];
            ...
            {steps.map((step) => (
                <div
                    ...
                    className={`flex flex-row items-center md:p-3 p-2 transition-all w-full md:w-1/4 rounded-full gap-2 z-10
                        ${step.value === currentStep ? "border-5 border-yellow-300 bg-indigo-600" :
